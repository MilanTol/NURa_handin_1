...
in between the two data points the two interpolators do not match well, compared to how well the two methods match the data. 
...
in Figure \ref{fig:LU_neville_comparison}, we can see that at the data points the plot spikes down to 
the errors that we plotted in the previous two plots. I do not know why the difference 
becomes so noisy for values of x between 40000 and 80000. It could be a result of roundoff error, but then 
why would it only be present in this range? 
